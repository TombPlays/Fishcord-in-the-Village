...
Last README file update: Fri May 14 07:43:16 UTC 2021
...
command.floormats
command.floormats.help
command.floormats.help.topic
command.floormats.reset
command.floormats.tools
command.fly
command.fly.player
command.forceload
...
command.locate.cobbler:shulker_factory
...
command.locate.stables:large_barn
...
command.locate.thatched:village_thatched
command.locate.village
command.locate.workshopsofdoom:badlands_mines
command.locate.workshopsofdoom:desert_quarry
command.locate.workshopsofdoom:mountain_mines
command.locate.workshopsofdoom:plains_quarry
command.locate.workshopsofdoom:workshop
command.locatebiome
...
command.oad
command.oad.command
command.oad.command.option
command.oad.command.option.action
command.oad.command.option.action.value
command.op
command.op.targets
...
command.oresabovediamonds
command.oresabovediamonds.command
command.oresabovediamonds.command.option
command.oresabovediamonds.command.option.action
command.oresabovediamonds.command.option.action.value
command.pardon
command.pardon-ip
